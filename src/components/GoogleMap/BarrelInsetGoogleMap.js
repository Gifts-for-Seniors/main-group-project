...
class InsetGoogleMap extends Component {
  render() {
    ...
    let test = `https://maps.googleapis.com/maps/api/staticmap?center=${city},${street},${zipcode}&zoom=10&size=350x350&markers=size:large%7Ccolor:blue%7C${street}+${zipcode}&key=AIzaSyD8TNMTi3MN10c4GKvbbFXailCferoIxkk
`;
