...
<<<<<<< HEAD
    let test = `https://maps.googleapis.com/maps/api/staticmap?center=${city}&zoom=10&size=350x350&markers=size:large%7Ccolor:blue%7C${street}+${zipcode}&key=AIzaSyD8TNMTi3MN10c4GKvbbFXailCferoIxkk
`;
=======
...
>>>>>>> 5b076d2c878837fbd3788bdd09d6a5ac46d28463
