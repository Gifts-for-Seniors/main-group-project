...
class InsetGoogleMap extends Component {
  render() {
    ...
    let test = `https://maps.googleapis.com/maps/api/staticmap?center=${city}&zoom=10&size=350x350&markers=size:large%7Ccolor:blue%7C${street}+${zipcode}&key=AIzaSyBO0rpYYzdrAOMFk-JvwoMIy_atxT1U7PE
`;
